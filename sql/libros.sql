...
('Hábitos Atómicos', 'Cómo construir hábitos que cambien tu vida.', 'Habitos_Atomicos.webp', 45.00),
('No Me Puedes Lastimar', 'Una historia inspiradora de superación personal.', 'NO_ME_PUEDES_LASTIMAR.webp', 55.00),
('Psicología Oscura', 'Una exploración de la mente humana.', 'PSICOLOGIA_OSCURA.jpg', 50.00),
('Química Lumbreras', 'Guía práctica para estudiantes de química.', 'Quimica_Lumbreras.webp', 40.00),
('Romper el Círculo', 'Una novela sobre el amor y las segundas oportunidades.', 'ROMPER_EL_CIRCULO.webp', 47.00),
